...
ruta = "./ImagenesLetras/Entrenamiento/";
formato = ".tif";
...
for i=1: numClases
    ...
    for j = 1: numImgClase
        ...
        nombreImagen = ruta + nombreClases(i) + num2str(j) + formato;
...
save('./01_GeneracionDatos/DatosGenerados/ConjuntoDatos/conjunto_datos.mat', 'X', 'Y', "nombresProblema");
...
save('./01_GeneracionDatos/DatosGenerados/ConjuntoDatos/conjunto_datos_estandarizados.mat', 'Z', 'Y', "nombresProblema");
save('./01_GeneracionDatos/DatosGenerados/ConjuntoDatos/datos_estandarizacion.mat', "medias", "desviaciones");
