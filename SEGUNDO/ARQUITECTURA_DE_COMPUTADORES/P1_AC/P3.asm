...
Rutina_Servicio proc  
    ...
    cmp contador, 3 ;comparamos contador con 1
...
Reside:
    ...
    mov ax, 0
    mov es, ax
    mov si, 1Ch*4 ;Interrupcion que llama al reloj cada cierto tiempo*4 que es el tamaño del vector(1s la int se ejecuta 18.2 vces)
