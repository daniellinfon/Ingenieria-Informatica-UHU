...
public class AtacarEnfermera extends Accion {
	...
	public ACTIONS doAction(Mundo m) {
		...
		double posXenf = enfermera.x / m53.getBloque();
		double posYenf = enfermera.y / m53.getBloque();
		...
		Node finalNode = new Node((int) posXenf, (int) posYenf);

		AStar aStar = new AStar(m53.getAnchura(), m53.getAltura(), initialNode, finalNode);
		aStar.setBlocks(m53.getBlocksArrayInf());
